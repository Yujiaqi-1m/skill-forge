...
Copy-ready detail for the task-scheduler skill. Cited from SKILL.md as
...
<plist version="1.0"><dict>
  ...
  <key>ProgramArguments</key><array>
    ...
    task-scheduler triggered-execution step for
...
```cron
4 18 27 8 * cd /Users/dev/pkg && claude -p "Scheduled task <id> fired: run the task-scheduler triggered-execution step for <id> in /Users/dev/pkg."
```
